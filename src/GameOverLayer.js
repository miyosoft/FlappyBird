...
var GameOverLayer = cc.Layer.extend({
    ...
    calcScore: function () {
        ...
        var delayTime, delay, incrementSeq;
        if (this.score > 0) {
            var i = 1;
            delayTime = (0.5 / this.score);
            delay = new cc.DelayTime(delayTime);
            incrementSeq = new cc.Sequence(
                delay,
                cc.callFunc(function () {
        ...
        if (this.score > this.lastBestScore) {
            ...
            delayTime = (0.5 / this.score - this.lastBestScore);
            delay = new cc.DelayTime(delayTime);
            incrementSeq = new cc.Sequence(
                delay,
                cc.callFunc(function () {
