var res = {
    ...
    game_title_png: "res/images/game_title.png",
    ground_png: "res/images/ground.png",
    play_button_png: "res/images/play.png",
    rank_button_png: "res/images/rank.png",
    ready_png: "res/images/ready.png",
    tap_png: "res/images/tap.png",
    map00_tmx: "res/images/map00.tmx",
    map01_tmx: "res/images/map01.tmx",
    pipe_up_png: "res/images/pipe_up.png",
    pipe_down_png: "res/images/pipe_down.png",
    scoreboard_png: "res/images/scoreboard.png",
    new_best_png: "res/images/new.png",
    game_over_png: "res/images/game_over.png",
